  ...
  return (
    <div data-testid="home-page" className="space-y-12">
      ...
      >
        ...
        {/* Animated Icon */}
        <div data-testid="hero-icon" className="relative mx-auto mb-8 w-24 h-24">
        ...
        {/* Title */}
        <h1 data-testid="home-title" className="text-6xl md:text-7xl font-black mb-4 leading-tight">
          <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent animate-gradient">
            QA Notes
          </span>
        </h1>
        
        <div data-testid="home-subtitle" className="flex items-center justify-center gap-2 mb-6">
        ...
        <p data-testid="home-description" className="text-xl text-slate-300 max-w-3xl mx-auto mb-8 leading-relaxed">
        ...
        {/* Stats Bar */}
        <div data-testid="stats-bar" className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
      ...
      {/* Topics Grid */}
      <div data-testid="topics-section">
        <div className="flex items-center gap-3 mb-6">
          <Globe className="h-8 w-8 text-blue-400" />
          <h2 data-testid="topics-title" className="text-4xl font-bold bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">
            9 Comprehensive Topics
          </h2>
        </div>
        
        <div data-testid="topics-grid" className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {topics.map((topic) => {
            ...
            return (
              ...
              >
                {isComplete && (
                  <div data-testid={`topic-complete-badge-${topic.id}`} className="absolute -top-2 -right-2 bg-green-500 rounded-full p-1 shadow-lg z-10">
                ...
                {!isComplete && (
                  <div data-testid={`topic-coming-soon-${topic.id}`} className="text-xs text-slate-400 text-center bg-slate-700/50 rounded-full px-2 py-1">
                    Coming Soon
                  </div>
                )}
              </GlassCard>
      ...
      <div data-testid="features-section">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 data-testid="features-title" className="text-4xl font-bold bg-gradient-to-r from-white to-yellow-200 bg-clip-text text-transparent">
            Why QA Notes?
          </h2>
        </div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 data-testid="getting-started-title" className="text-4xl font-bold bg-gradient-to-r from-white to-cyan-200 bg-clip-text text-transparent">
            Getting Started
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div data-testid="step-1" className="flex items-start gap-4 group/step hover:translate-x-2 transition-transform">
            ...
            <div data-testid="step-2" className="flex items-start gap-4 group/step hover:translate-x-2 transition-transform">
          ...
          <div className="space-y-4">
            <div data-testid="step-3" className="flex items-start gap-4 group/step hover:translate-x-2 transition-transform">
            ...
            <div data-testid="step-4" className="flex items-start gap-4 group/step hover:translate-x-2 transition-transform">
        ...
        <div className="mt-8 text-center">
          <div data-testid="start-learning-cta" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500/30 via-cyan-500/30 to-purple-500/30 rounded-2xl border-2 border-blue-400/40 shadow-lg hover:shadow-blue-500/50 hover:scale-105 transition-all duration-300 cursor-pointer group/cta">
